...
// will be matched as itself; for example, {.*}.jnichols.{.*} matches any subdomain and top-level domain for
// jnichols. Patterns *must* contain some regex. It performs generally equivalent to the exact same regex in
